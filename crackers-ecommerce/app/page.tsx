        ...
        <div className="container flex h-14 items-center">
          ...
          <div className="flex flex-1 items-center justify-end space-x-4">
            <nav className="flex items-center space-x-3">
              <Link
                href="/secure-chat"
                className="text-xs font-semibold text-cyan-500 bg-cyan-950/40 border border-cyan-500/30 rounded-full px-2.5 py-1 transition-all hover:bg-cyan-950/80 hover:text-cyan-400 flex items-center gap-1.5 animate-pulse"
              >
          ...
          <div className="flex-1 space-y-4">
            <div className="text-lg font-medium">Quick Links</div>
             <nav className="flex flex-col gap-2 text-sm text-muted-foreground">
              ...
              <Link href="/secure-chat" className="hover:underline text-cyan-500 font-semibold flex items-center gap-1">
